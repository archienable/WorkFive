...
const MyStores = () => {
    ...
    return (
        <div>
            ...
            <div className='contentBlockMyStores'>
                <div className='blockHeader blockEach'>
                    <div className='eachItem numberItem'>№</div>
                    <div className='eachItem nameItem'>Название</div>
                    <div className='eachItem addressItem'>Адрес</div>
                    <div className='eachItem actionItem'>Действие</div>
                </div>
                <div className='blockList blockEach'>
                        <div className='dataItem eachItem blockNumberItem'>12345</div>
                        <div className='dataItem eachItem blockNameItem'>Дипломная работа</div>
                        <div className='dataItem eachItem blockActionItem'>http://www.work5.ru/services</div>
                    <div className='blockButtons'>
                        <Button variant="success" className='btnRedactor'>
                            <svg width="15" height="18" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g >
                                    ...
                                    <path d="M2.0602 14.0806L2.01664 14.07L0.934683 13.0157C0.901193 12.9636 0.911261 12.922 0.921329 12.8804C0.974954 12.8494 1.01851 12.86 1.06207 12.8705L2.14403 13.9248C2.17752 13.9769 2.16745 14.0185 2.15738 14.0601C2.14731 14.1016 2.10376 14.0911 2.0602 14.0806Z" fill="white" stroke="white" />
                                ...
                                <defs>
                                    <clipPath id="clip0_11_31">
                                        <rect width="10.8008" height="15.2084" fill="white" transform="translate(3.57916) rotate(13.6118)"/>
                                    </clipPath>
                                </defs>
                            </svg>
                            Редактировать
                        </Button>
                        <Button variant="secondary" className='btnRedactorDelete'>
                            <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.00005 1.23053L12.1428 12.7694" stroke="white" />
                                <path d="M12.1429 1.2403L1.00911 12.7694" stroke="white" />
                            </svg>
                            Редактировать
                        </Button>
                    </div>
