...
import DropDown from "../PopUp/DropDown/DropDown";
import Input from "../PopUp/Input/Input";
        ...
        <div>
            <Modal show={show} onHide={handleClose} backdrop="static"
                ...
                <Modal.Body>
                    <div className='dropDownBlock'>
                        <div className='dropDownSample'>
                            Шаблон
                            <DropDown className='componentDropDown'/>
                        </div>
                        <div>
                            Цветовая схема
                            <DropDown />
                ...
                <Modal.Footer>
                    ...
                    <Button className='btnCreateModal' variant="success" onClick={handleClose}>
                        Создать
                    </Button>
                </Modal.Footer>
            </Modal>
